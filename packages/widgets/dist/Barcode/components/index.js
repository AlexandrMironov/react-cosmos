(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("@alexmironov/cosmos", [, ], factory);
	else if(typeof exports === 'object')
		exports["@alexmironov/cosmos"] = factory(require("react"), require("react-dom"));
	else
		root["@alexmironov/cosmos"] = factory(root[undefined], root[undefined]);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return applyMiddleware; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return bindActionCreators; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "f", function() { return createStore; });
...
var textReducer = toolkit_1.createSlice({
  name: 'widgets/TextField',
  initialState: initialState,
  reducers: {
    addFooToText: function addFooToText(state, action) {
      state.textValue = action.payload;
    },
    delFooText: function delFooText(state, action) {
      state.textValue = '';
    }
  }
});
exports.addFooToText = (_a = textReducer.actions, _a.addFooToText), exports.delFooText = _a.delFooText;
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "createNextState", function() { return /* reexport */ immer_esm; });
__webpack_require__.d(__webpack_exports__, "__DO_NOT_USE__ActionTypes", function() { return /* reexport */ redux["a" /* __DO_NOT_USE__ActionTypes */]; });
__webpack_require__.d(__webpack_exports__, "applyMiddleware", function() { return /* reexport */ redux["b" /* applyMiddleware */]; });
__webpack_require__.d(__webpack_exports__, "bindActionCreators", function() { return /* reexport */ redux["c" /* bindActionCreators */]; });
__webpack_require__.d(__webpack_exports__, "combineReducers", function() { return /* reexport */ redux["d" /* combineReducers */]; });
__webpack_require__.d(__webpack_exports__, "compose", function() { return /* reexport */ redux["e" /* compose */]; });
__webpack_require__.d(__webpack_exports__, "createStore", function() { return /* reexport */ redux["f" /* createStore */]; });
__webpack_require__.d(__webpack_exports__, "createSelector", function() { return /* reexport */ createSelector; });
__webpack_require__.d(__webpack_exports__, "configureStore", function() { return /* binding */ configureStore; });
__webpack_require__.d(__webpack_exports__, "createAction", function() { return /* binding */ createAction; });
__webpack_require__.d(__webpack_exports__, "createAsyncThunk", function() { return /* binding */ createAsyncThunk; });
__webpack_require__.d(__webpack_exports__, "createEntityAdapter", function() { return /* binding */ createEntityAdapter; });
__webpack_require__.d(__webpack_exports__, "createReducer", function() { return /* binding */ createReducer; });
__webpack_require__.d(__webpack_exports__, "createSerializableStateInvariantMiddleware", function() { return /* binding */ createSerializableStateInvariantMiddleware; });
__webpack_require__.d(__webpack_exports__, "createSlice", function() { return /* binding */ createSlice; });
__webpack_require__.d(__webpack_exports__, "findNonSerializableValue", function() { return /* binding */ findNonSerializableValue; });
__webpack_require__.d(__webpack_exports__, "getDefaultMiddleware", function() { return /* binding */ getDefaultMiddleware; });
__webpack_require__.d(__webpack_exports__, "getType", function() { return /* binding */ getType; });
__webpack_require__.d(__webpack_exports__, "isPlain", function() { return /* binding */ isPlain; });
__webpack_require__.d(__webpack_exports__, "unwrapResult", function() { return /* binding */ unwrapResult; });
...
var composeWithDevTools = typeof window !== 'undefined' && window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ ? window.__REDUX_DEVTOOLS_EXTENSION_COMPOSE__ : function () {
  ...
  if (typeof arguments[0] === 'object') return redux["e" /* compose */];
  return redux["e" /* compose */].apply(null, arguments);
};
...
function configureStore(options) {
  ...
  if (typeof reducer === 'function') {
    ...
    rootReducer = Object(redux["d" /* combineReducers */])(reducer);
  } else {
    throw new Error('"reducer" is a required argument, and must be a function or an object of functions that can be passed to combineReducers');
  }

  var middlewareEnhancer = redux["b" /* applyMiddleware */].apply(void 0, middleware);
  var finalCompose = redux["e" /* compose */];
  ...
  return Object(redux["f" /* createStore */])(rootReducer, preloadedState, composedEnhancer);
}
...
exports.Barcode = function () {
  ...
  var onClearClick = function onClearClick() {
    dispatch(index_1.delFooText(null));
  };

  var storeText = function storeText(e) {
...
__webpack_require__.d(__webpack_exports__, "batch", function() { return /* reexport */ external_commonjs_react_dom_commonjs2_react_dom_umd_react_dom_["unstable_batchedUpdates"]; });
...
// EXTERNAL MODULE: external {"commonjs":"react","commonjs2":"react","umd":"react"}
var external_commonjs_react_commonjs2_react_umd_react_ = __webpack_require__(0);
var external_commonjs_react_commonjs2_react_umd_react_default = /*#__PURE__*/__webpack_require__.n(external_commonjs_react_commonjs2_react_umd_react_);
...
/*#__PURE__*/
external_commonjs_react_commonjs2_react_umd_react_default.a.createContext(null);
...
function Provider(_ref) {
  ...
  var contextValue = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
  ...
  var previousState = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
    return store.getState();
  }, [store]);
  Object(external_commonjs_react_commonjs2_react_umd_react_["useEffect"])(function () {
  ...
  return external_commonjs_react_commonjs2_react_umd_react_default.a.createElement(Context.Provider, {
    value: contextValue
  }, children);
}
...
var useIsomorphicLayoutEffect = typeof window !== 'undefined' && typeof window.document !== 'undefined' && typeof window.document.createElement !== 'undefined' ? external_commonjs_react_commonjs2_react_umd_react_["useLayoutEffect"] : external_commonjs_react_commonjs2_react_umd_react_["useEffect"];
...
_ref) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    ...
    var usePureOnlyMemo = pure ? external_commonjs_react_commonjs2_react_umd_react_["useMemo"] : function (callback) {
      return callback();
    };

    function ConnectFunction(props) {
      var _useMemo = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
      ...
      var ContextToUse = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
        // Users may optionally pass in a custom context instance to use instead of our ReactReduxContext.
        // Memoize the check that determines which context instance we should use.
        return propsContext && propsContext.Consumer && Object(react_is["isContextConsumer"])(external_commonjs_react_commonjs2_react_umd_react_default.a.createElement(propsContext.Consumer, null)) ? propsContext : Context;
      }, [propsContext, Context]); // Retrieve the store and ancestor subscription via context, if available

      var contextValue = Object(external_commonjs_react_commonjs2_react_umd_react_["useContext"])(ContextToUse); // The store _must_ exist as either a prop or in context.
      ...
      var childPropsSelector = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
        // The child props selector needs the store reference as an input.
        // Re-create this selector whenever the store changes.
        return createChildSelector(store);
      }, [store]);

      var _useMemo2 = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
      ...
      var overriddenContextValue = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
      ...
      var _useReducer = Object(external_commonjs_react_commonjs2_react_umd_react_["useReducer"])(storeStateUpdatesReducer, EMPTY_ARRAY, initStateUpdates),
      ...
      var lastChildProps = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])();
      var lastWrapperProps = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])(wrapperProps);
      var childPropsFromStoreUpdate = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])();
      var renderIsScheduled = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])(false);
      ...
      var renderedWrappedComponent = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
        return external_commonjs_react_commonjs2_react_umd_react_default.a.createElement(WrappedComponent, _extends({}, actualChildProps, {
          ref: forwardedRef
        }));
      }, [forwardedRef, WrappedComponent, actualChildProps]); // If React sees the exact same element reference as last time, it bails out of re-rendering
      // that child, same as if it was wrapped in React.memo() or returned false from shouldComponentUpdate.

      var renderedChild = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
        if (shouldHandleStateChanges) {
          // If this component is subscribed to store updates, we need to pass its own
          // subscription instance down to our descendants. That means rendering the same
          // Context instance, and putting a different value into the context.
          return external_commonjs_react_commonjs2_react_umd_react_default.a.createElement(ContextToUse.Provider, {
    ...
    var Connect = pure ? external_commonjs_react_commonjs2_react_umd_react_default.a.memo(ConnectFunction) : ConnectFunction;
    Connect.WrappedComponent = WrappedComponent;
    Connect.displayName = displayName;

    if (forwardRef) {
      var forwarded = external_commonjs_react_commonjs2_react_umd_react_default.a.forwardRef(function forwardConnectRef(props, ref) {
        return external_commonjs_react_commonjs2_react_umd_react_default.a.createElement(Connect, _extends({}, props, {
          forwardedRef: ref
        }));
      });
...
function whenMapDispatchToPropsIsObject(mapDispatchToProps) {
  return mapDispatchToProps && typeof mapDispatchToProps === 'object' ? wrapMapToPropsConstant(function (dispatch) {
    return Object(redux["c" /* bindActionCreators */])(mapDispatchToProps, dispatch);
  }) : undefined;
}
...
function useReduxContext_useReduxContext() {
  var contextValue = Object(external_commonjs_react_commonjs2_react_umd_react_["useContext"])(ReactReduxContext);
...
function createStoreHook(context) {
  ...
  var useReduxContext = context === ReactReduxContext ? useReduxContext_useReduxContext : function () {
    return Object(external_commonjs_react_commonjs2_react_umd_react_["useContext"])(context);
  };
...
function useSelectorWithStoreAndSubscription(selector, equalityFn, store, contextSub) {
  var _useReducer = Object(external_commonjs_react_commonjs2_react_umd_react_["useReducer"])(function (s) {
    return s + 1;
  }, 0),
      forceRender = _useReducer[1];

  var subscription = Object(external_commonjs_react_commonjs2_react_umd_react_["useMemo"])(function () {
    return new Subscription(store, contextSub);
  }, [store, contextSub]);
  var latestSubscriptionCallbackError = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])();
  var latestSelector = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])();
  var latestSelectedState = Object(external_commonjs_react_commonjs2_react_umd_react_["useRef"])();
  var selectedState;
...
/*#__PURE__*/
createSelectorHook();
// EXTERNAL MODULE: external {"commonjs":"react-dom","commonjs2":"react-dom","umd":"react-dom"}
var external_commonjs_react_dom_commonjs2_react_dom_umd_react_dom_ = __webpack_require__(6);
...
setBatch(external_commonjs_react_dom_commonjs2_react_dom_umd_react_dom_["unstable_batchedUpdates"]);
